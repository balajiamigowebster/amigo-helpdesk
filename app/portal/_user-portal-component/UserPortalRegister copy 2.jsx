...
export default function UserPortalRegister({ org, portalData, themeConfig }) {
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans selection:bg-indigo-100">
      ...
      <header
        className={`${themeConfig.banner} relative pt-24 pb-20 px-4 overflow-hidden shadow-2xl`}
      >
      ...
      <main className="grow px-4 -mt-24 z-10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 hidden lg:block sticky top-10">
            <div className="relative group p-4">
              ...
              <img
                ...
                className="w-full h-auto rounded-[3rem] shadow-2xl transform  group-hover:rotate-0 transition-transform duration-700 border-4 border-white"
              />
          ...
          <div className="lg:col-span-6 mt-10 w-full max-w-lg mx-auto lg:ml-auto">
