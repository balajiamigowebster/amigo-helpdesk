...
const EditEmployeeModal = ({ employee, open, setOpen }) => {
    ...
    bg-yellow-50"
        ...
        <div className="flex flex-col md:flex-row gap-10 mt-4">
          ...
          <div className="flex-1 space-y-6">
              ...
              >
                ...
                >
                  ...
                  <SelectContent className="rounded-xl">
                    {/* Short-ah loop panni roles-ai show panrom */}
                    {ROLES.map((role) => (
            ...
            {/* <div className="relative">
              <label className="absolute -top-2.5 left-3 px-1 bg-[#f0f2f5] text-[12px] font-medium text-slate-500 z-10">
                Hourly rate
              </label>
              <Input
                name="hourlyRate"
                ...
                onChange={handleChange}
                className="w-full rounded-lg h-12 border-slate-300 bg-transparent font-bold"
              />
            </div> */}
