...
const SETTINGS_CATEGORIES = [
  ...
  { label: "Organization", value: "ORGANIZATION" }, // Trigger field
];
  ...
  return (
    <div className=" bg-[#f8fafc]">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Selection Cards */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-10 items-end">
          <div className="bg-white p-5 rounded-3xl border border-blue-200 shadow-xl shadow-blue-50 animate-in fade-in slide-in-from-top-2 duration-500 ">
          ...
          <div className="bg-white p-5 rounded-3xl border border-purple-200 shadow-xl shadow-purple-100 animate-in fade-in slide-in-from-top-2 duration-500">
            <div className="flex items-center gap-3 mb-3 text-purple-600">
              <Settings2 size={18} />
              <span className="text-[10px] font-black uppercase">Headings</span>
            </div>
            <Select
              onValueChange={(val) => {
          ...
          {/* 3. ORGANIZATION (Enabled only if Heading is ORGANIZATION) */}
          {selectedCategory === "ORGANIZATION" && (
            <div className="bg-white p-5 rounded-3xl border border-green-200 shadow-xl shadow-green-50 animate-in fade-in slide-in-from-top-2 duration-500">
              ...
              <Select onValueChange={setSelectedOrg} value={selectedOrg}>
                <SelectTrigger className="w-full rounded-lg h-12 border-slate-200 shadow-green-50 bg-slate-50/50">
                  <SelectValue
                    placeholder={
          ...
          {/* 4. GENERAL/TICKETS (SHOW ONLY if Organization is selected) */}
          {selectedOrg && (
            <div className="bg-white p-5 rounded-3xl border border-orange-200 shadow-xl shadow-orange-50 animate-in fade-in slide-in-from-top-2 duration-500">
              ...
              <Select
                onValueChange={setSelectedGeneral}
                value={selectedGeneral}
              >
                <SelectTrigger className="w-full rounded-lg h-12 border-slate-200 bg-white">
