...
export async function middleware(request) {
  ...
  // --- ITHU THAAN SPECIFIC BYPASS ---
  // API path-la '/custom-attributes' irunthaal token check pannaama skip pannu
  if (pathname.includes("/custom-attributes")) {
